...
class RecordPatientDetail1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.pushReplacement(context,MaterialPageRoute(builder: (context)=>DashboardDoctor()));
        return false;
      },
      child: BlocProvider<LayoutCubit>(
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('Description:  ', maxLines: 4 ,style: TextStyle(fontWeight: FontWeight.bold,color:primaryColor1,fontSize: 15)),
